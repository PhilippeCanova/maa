...
class RetrieveData_TestCase(StaticLiveServerTestCase):
    ...
    def test_retrieve_datas(self):
        ...
        with patch('donneur.commons.request_data_cdp') as mock_request_data_cdp:
    ...
    def test_report_becmg_tempo(self):
    ...
    def test_assembleur(self, mock_request_data_cdp):
        ...
        self.assertEqual( self.batterie_tests(assembleur, datetime(2021,11,11,1,0,0), 'EEEE'), ['TS', 'VENT'])
        ...
        self.assertEqual( self.batterie_tests(assembleur, datetime(2021,11,11,2,0,0), 'EEEE'), ['GR'])
        ...
        self.assertEqual( self.batterie_tests(assembleur, datetime(2021,11,11,11,0,0), 'EEEE'), ['TS', 'VENT'])
