...
INSTALLED_APPS = [
    'maa_django.apps.income.apps.IncomeConfig',
    'maa_django.apps.core.apps.CoreConfig',
    'maa_django.apps.site.apps.SiteConfig',
    'donneur',
    'analyseur',
    'configurateur',
    'producteur',
...
STATICFILES_DIRS = [
    Path(BASE_DIR).joinpath('maa_django').joinpath('site_static'),
]
